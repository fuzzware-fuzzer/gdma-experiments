target_dir="build_stm32f103_samples"
sample1_dir="stm32f103_usart_dma_build_dir"
tag="stm32f103-build-env"
...
mkdir output
cp -r /tmp/$target_dir/output/stm32f103_usart_contiguous.elf output
