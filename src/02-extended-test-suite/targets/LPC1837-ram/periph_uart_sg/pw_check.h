...
__attribute__ ((noinline)) void pwcheck_success(void) {
...
int num_correct = 0;
__attribute__ ((noinline)) void pwcheck_passed_1(void) {++num_correct;}
__attribute__ ((noinline)) void pwcheck_passed_2(void) {++num_correct;}
__attribute__ ((noinline)) void pwcheck_passed_3(void) {++num_correct;}
__attribute__ ((noinline)) void pwcheck_passed_4(void) {++num_correct;}
__attribute__ ((noinline)) void pwcheck_passed_5(void) {++num_correct;}
__attribute__ ((noinline)) void pwcheck_passed_6(void) {++num_correct;}
__attribute__ ((noinline)) void pwcheck_passed_7(void) {++num_correct;}
__attribute__ ((noinline)) void pwcheck_passed_8(void) {++num_correct;}
