...
find . -name sl_uartdrv_leuart_inst_config.h -exec sed -i 's/uartdrvFlowControlHwUart/uartdrvFlowControlNone/g' {} \;
cd projects
...
cp /home/ubuntu/silabs-new/projects/build/debug/test.out /home/ubuntu/silabs-new/projects/build/debug/test.elf
cp /home/ubuntu/silabs-new/projects/build/debug/test.elf $out_dir
