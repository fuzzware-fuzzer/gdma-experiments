target_dir="build_renesas_picohttp"
sample1_dir="picohttpparser/"
tag="renesas-picohttp-build-env"
...
cp -r /tmp/$target_dir/output/spi_ek_ra4w1_ep.elf output/renesas_picohttpparser.elf
