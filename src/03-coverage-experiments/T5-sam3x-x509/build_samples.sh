...
mv /opt/mbedtls /opt/samples/sam3x_uart_scatter/
# compile user project
cd $sample1_dir; ln -s ../src/ . ; mv ../../Makefile . ; make clean; make all; cp $sample1_output /opt/samples/output/$sample1_final_name
