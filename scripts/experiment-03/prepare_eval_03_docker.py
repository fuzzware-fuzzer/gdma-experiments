...
def main(args):
    # run prepare script first
    if args.update:
        run_fuzzware_docker([ "python3",f"scripts/experiment-03/prepare_eval_03.py", "-u"], 1, 0, True)
    else:
        run_fuzzware_docker([ "python3",f"scripts/experiment-03/prepare_eval_03.py"], 1, 0, True)
